...
| 7 | Error states | toast/modal | • GPS OFF: E-sport-matching-001 (modal yêu cầu bật)<br>• Không tìm thấy: E-sport-matching-006 (inline message + gợi ý filter)<br>• Match pending: E-sport-matching-004 (toast)<br>• Hết limit: E-sport-matching-005 (toast + link Premium) |
